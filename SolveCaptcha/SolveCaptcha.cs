...
using SolveCaptcha.Exceptions;
using TimeoutException = SolveCaptcha.Exceptions.TimeoutException;
...
namespace SolveCaptcha
{
    public class SolveCaptcha
    {
         ...
         */
        public int SoftId { get; set; } = 4848;
         ...
         * @param apiKey
         */
        public SolveCaptcha(string apiKey) : this()
        {
            ApiKey = apiKey;
        }
